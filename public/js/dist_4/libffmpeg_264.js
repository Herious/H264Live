...
var STATIC_BASE = 1024, STACK_BASE = 5481792, STACKTOP = STACK_BASE, STACK_MAX = 238912, DYNAMIC_BASE = 5481792, DYNAMICTOP_PTR = 237984;
...
var wasmBinaryFile = "libffmpeg_264.wasm";
...
var __main_thread_futex_wait_address = 238896;
...
var PThread = {
 ...
 initMainThreadBlock: function() {
  ...
  PThread.mainThreadBlock = 238144;
  ...
  worker.onmessage = function(e) {
   ...
   if (d["targetThread"] && d["targetThread"] != _pthread_self()) {
    ...
    return;
      ...
      if (cmd === 'refresh') {
        console.log('refresh screen size %dx%d', d.width, d.height);
        var obj = {
            yData : HEAPU8.subarray(d.addr_y, d.addr_y + d.ysize),
            uData : HEAPU8.subarray(d.addr_u, d.addr_u + d.usize),
            vData : HEAPU8.subarray(d.addr_v, d.addr_v + d.vsize),
            width : d.width,
            height : d.height
        };
      ...
      else if (cmd === "processQueuedMainThreadWork") {
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("libffmpeg_264.worker.js");
...
var ___tm_timezone = (stringToUTF8("GMT", 238048, 4), 238048);
...
function _jsVideoCallback(addr_y, addr_u, addr_v, stride_y, stride_u, stride_v, width, height, pts, index) {
 console.log("New In video callback, size = %d * %d, stride_y = %d, stride_u = %d, stride_v = %d, pts = %d", width, height, stride_y, stride_u, stride_v, pts);
 if (0 == width || 0 == height) {
  return;
 }
...
function _notifyMainThread(i1, i2, i3, i4) {
 postMessage({
  cmd: "decode_result"
 });
}
...
var asmLibraryArg = {
 ...
 "jsAdd": _jsAdd,
 "jsVideoCallback": _jsVideoCallback,
 "localtime_r": _localtime_r,
 "memory": wasmMemory,
 "mktime": _mktime,
 "notifyMainThread": _notifyMainThread,
...
var _decodeOneFrame = Module["_decodeOneFrame"] = createExportWrapper("decodeOneFrame");
...
Module["_ff_h264_cabac_tables"] = 43254;
