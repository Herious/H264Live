...
WebGLPlayer.prototype.renderFrameYUV = function (yData, uData, vData, width, height) {
    if (!this.gl) {
        console.log("[ER] Render frame failed due to WebGL not supported.");
        return;
    }
    ...
    gl.y.fill(width, height, yData);
    gl.u.fill(width >> 1, height >> 1, uData);
    gl.v.fill(width >> 1, height >> 1, vData);
